...
`GOVERNANCE/` is the repository-native maintenance/control-plane entry point. It routes public maintenance, retained governance design material, and memoryless Independent GPT recovery without replacing implementation, evidence contracts, research content, or private Jules task controls.
