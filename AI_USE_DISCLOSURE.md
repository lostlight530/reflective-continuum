...
AI-generated summaries must not collapse independent runtime facts into one global state when this independent review framework is applied.
...
Weekly or monthly AI-generated summaries inherit Daily uncertainty when this review framework is applied to them. This is a post-hoc governance rule, not a claim about Jules task behavior.

A later successful snapshot does not erase an earlier error, and a higher-level report may not strengthen evidence without a new explicit source or observation.
